...
public class homecareadapter extends RecyclerView.Adapter<homecareadapter.ViewHolder>  {
    ...
    public homecareadapter(Context context,BaseCatSubCatBean mBaseCatSubCatBean, ArrayList<CategoryBean> mCategoryBeanArrayList, int ivHeight, int ivWidth, FragmentManager fragmentManager) {
    ...
    @Override
    public homecareadapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.home_frag_recycler_row2, viewGroup, false);
        return new homecareadapter.ViewHolder(view);
    }



    @Override
    public void onBindViewHolder(homecareadapter.ViewHolder viewHolder, final int i) {
