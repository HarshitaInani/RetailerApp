...
import app.retailer.krina.shop.com.mp_shopkrina_retailer.customClasses.FontCache;
...
public class FavoriteAdapter   extends RecyclerView.Adapter<FavoriteAdapter.ViewHolder> {
    ...
    public FavoriteAdapter(Context context, ArrayList<ItemList> itemListArrayList, int ivWidth, int ivHeight, TextView tvTotalItemPrice, TextView tvTotalItemQty , TextView tvTotalDp ) {
...
//                    jsonObject.put(""+itemListArrayList.get(i).getItemId(), "1");
        ...
        viewHolder.tvDpPoint.setText("Dp "+itemListArrayList.get(i).getDreamPoint());
        ...
        ArrayList<CartItemInfo> mCartItemInfos = ((HomeActivity) context).getCartItem().getmCartItemInfos();
