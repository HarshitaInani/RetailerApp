...
public class HomeFragNewlyAddedAdapter extends RecyclerView.Adapter<HomeFragNewlyAddedAdapter.ViewHolder> {
    ...
    @Override
    public HomeFragNewlyAddedAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_list_frag_item_row, viewGroup, false);
        return new HomeFragNewlyAddedAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final HomeFragNewlyAddedAdapter.ViewHolder viewHolder, final int i) {
